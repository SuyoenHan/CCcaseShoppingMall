...
<div id="contents"> 
		...
		<div id="companyInfoImg" class="companyInfocel">
			<img src="/MyMVC/images/ png"  />
		</div>
		<br>
		<div  id="companyInfotext" class="companyInfocel">
		...
		<div class="companyInfocel" id="companyLocation">
			  <span>위치</span><br>
			    대한민국 서울특별시 마포구<br>
