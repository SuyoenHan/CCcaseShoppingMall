				...
				<table>
					<tbody>
						<tr> 
							...
							<td><input type="text" name="productname" class="pilsu1" id="productname" placeholder="ex) 냥냥케이스" /></td>				
						</tr>
						<tr> 
				...
				<table>
					<tbody>
						<tr> <%-- 제품상세명 : 회사명(mname) - 기종명(modelname) - productname(제품명)   --%>
							<td id="info8"><label class="Infoname" for="pname">1. 제품상세명</label></td>
							<td colspan="2"><input type="text" name="pname" id="pname" readonly="readonly" style="width:300px"/></td>				
						</tr>	
						<tr> 
							<td id="info9"><label class="Infoname" for="pcolor">2. 색상 <span style="color:red; font-size:10pt;">(필수)</span></label></td>
							<td>
						...
						<tr> 
							<td id="info10"><label class="Infoname" for="pqty">3. 입고량</label></td>
						...
						<tr> 
							<td id="info12"><label class="Infoname" for="pinputdate">5. 제품입고일자</label></td>
							<td><input type="date" name="pinputdate" id="pinputdate" /></td>				
						</tr>
						<tr> 
							<td id="info13"><label class="Infoname" for="doption">6. 배송조건<span style="color:red; font-size:10pt;">(필수)</span></label></td>
							<td>
						...
						<tr> 
							<td id="info14"><label class="Infoname" for="pcontent">7. 제품설명<br><br></label></td>
							<td colspan="2"><textarea name="pcontent" id="pcontent" rows="5" cols="40" placeholder="간단히 설명하세요" maxlength="100"></textarea></td>				
						</tr>
						<tr> 
							<td id="info15"><label class="Infoname" for="imgPlus1">8. 추가이미지1<span style="color:red; font-size:10pt;">(필수)</span></label></td>
							<td><input type="file" name="imgPlus1" id="imgPlus1" class="pilsu2" /></td>		
						</tr>
						<tr> 
							<td id="info16"><label class="Infoname" for="imgPlus2">9. 추가이미지2<span style="font-size:10pt;">(선택)</span></label></td>
							<td><input type="file" name="imgPlus2" id="imgPlus2" /></td>		
						</tr>
						<tr> 
							<td id="info17"><label class="Infoname" for="imgPlus3">10. 추가이미지3<span style="font-size:10pt;">(선택)</span></label></td>
